...
function UserProfile() {
  ...
  <div className="profile-info col-xl-3 col-sm-6 mb-3 mb-lg-0">
    ...
    <h5 className="mb-2 mt-3 ml-5  icon-text-warning">{user.workspaces.length}</h5>
  ...
  <div className="profile-info col-xl-3 col-sm-6 mb-3 mb-lg-0">
    ...
    <h5 className="mb-2 mt-3 ml-5 icon-text-info">35+</h5>
  ...
  <div className="profile-info col-xl-3 col-sm-6 mb-3 mb-sm-0">
    ...
    <h5 className="mb-2 mt-3 ml-5 icon-text-danger">04+</h5>
  ...
  <div className="profile-info col-xl-3 col-sm-6">
    ...
    <h5 className="mb-2 mt-3 ml-5 icon-text-success">90+</h5>

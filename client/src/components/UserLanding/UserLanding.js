...
function UserLanding() {
  return (
    ...
    {/* ======= Hero Section ======= */}
    <section id="hero" className="hero d-flex align-items-center sectionn">
    ...
    <main id="main">
      {/* ======= About Section ======= */}
      <section id="about" className="about sectionn">
      ...
      {/* ======= Values Section ======= */}
      <section id="values" className="values sectionn">
        <div className="container" data-aos="fade-up">
      ...
      {/* ======= Features Section ======= */}
      <section id="features" className="features sectionn">
        <div className="container" data-aos="fade-up">
          <header className="section-header">
            <h2>Features</h2>
